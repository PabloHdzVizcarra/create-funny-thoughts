...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _functions_addAlerts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/addAlerts */ \"./src/functions/addAlerts.js\");\n/* harmony import */ var _functions_deleteInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/deleteInputs */ \"./src/functions/deleteInputs.js\");\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  var form = document.querySelector('.js-form');\n  form.addEventListener('submit', function (event) {\n    event.preventDefault();\n    var inputs = Array.from(form.getElementsByTagName(\"input\"));\n    var values = inputs.map(function (input) {\n      return input.value;\n    });\n    var dataObj = {\n      title: values[0],\n      tought: values[1]\n    };\n    console.log(dataObj);\n    fetch('/', {\n      method: 'POST',\n      headers: {\n        'Content-Type': 'application/json'\n      },\n      body: JSON.stringify(dataObj)\n    }).then(function (res) {\n      return res.json();\n    }).then(function (data) {\n      console.log(data);\n      Object(_functions_deleteInputs__WEBPACK_IMPORTED_MODULE_1__[\"deleteInputs\"])('.js-form');\n      Object(_functions_addAlerts__WEBPACK_IMPORTED_MODULE_0__[\"addAlerts\"])('.js-messages', 'success', 'Pensamiento guardado con exito');\n    })[\"catch\"](function (err) {\n      return console.log(err);\n    });\n  });\n});\n\n//# sourceURL=webpack:///./src/index.js?");
