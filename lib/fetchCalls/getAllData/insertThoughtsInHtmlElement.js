import { createElementParagraph } from "../../../src/functions/createElementParagraph"

export const insertThoughtsInHtmlElement = (
  array,
  ...
  array.map(tought => {
    ...
    `<div class="card w-50 col-lg-3" data-id=${tought._id}>
        <div class="card-body">
          ...
          <p class="card-text">${tought.thought}</p>
        </div>
      </div>`
    )
  })
